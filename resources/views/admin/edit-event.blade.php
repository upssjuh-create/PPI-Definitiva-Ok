...
<head>
    ...
    <title>Editar Evento - CertificalFFar</title>
...
<body>
    ...
    <main class="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-600">Atualize os dados do evento</p>
        </div>
        ...
        <form id="event-form" onsubmit="handleSubmit(event); return false;">
            ...
            <div class="section-card bg-white rounded-xl shadow-md p-6 mb-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="title" id="title" placeholder="Ex: Semana Acadêmica de Tecnologia 2025" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1a5f3f] focus:border-[#1a5f3f]" required>
                    </div>

                    <!-- Descrição -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Descrição *</label>
                        <textarea name="description" id="description" rows="4" placeholder="Descreva o evento, objetivos e principais atividades..." class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1a5f3f] focus:border-[#1a5f3f]" required></textarea>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select name="category" id="category" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1a5f3f] focus:border-[#1a5f3f]" required>
                        ...
                        <div>
                            ...
                            <input type="text" name="organizer" id="organizer" placeholder="Ex: Departamento de Ciência da Computação" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1a5f3f] focus:border-[#1a5f3f]" required>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="date" name="date" id="date" placeholder="Ex: 15 de Março de 2025" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1a5f3f] focus:border-[#1a5f3f]" required>
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Horário *</label>
                            <input type="text" name="time" id="time" placeholder="Ex: 14:00 - 18:00" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1a5f3f] focus:border-[#1a5f3f]" required>
                        </div>
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Local *</label>
                        <input type="text" name="location" id="location" placeholder="Ex: Auditório Principal, Bloco A" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1a5f3f] focus:border-[#1a5f3f]" required>
                    </div>
                </div>
            </div>
            <!-- Capacidade e Preço -->
            <div class="section-card bg-white rounded-xl shadow-md p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" name="capacity" id="capacity" placeholder="100" min="1" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1a5f3f] focus:border-[#1a5f3f]" required>
                    </div>
            ...
            <div class="section-card bg-white rounded-xl shadow-md p-6 mb-6">
                ...
                <div>
                    ...
                    <input type="url" name="image" id="image" placeholder="https://exemplo.com/imagem.jpg" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1a5f3f] focus:border-[#1a5f3f]">
            ...
            <div class="section-card bg-white rounded-xl shadow-md p-6 mb-6">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="number" name="certificate_hours" id="certificate_hours" placeholder="40" min="0" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1a5f3f] focus:border-[#1a5f3f]">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Descrição do Certificado</label>
                        <textarea name="certificate_description" id="certificate_description" rows="3" placeholder="Texto que aparecerá no certificado..." class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1a5f3f] focus:border-[#1a5f3f]"></textarea>
                    </div>
            ...
            <!-- Alerta se evento já passou -->
            <div id="past-event-alert" class="hidden bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-6">
                <div class="flex">
                    ...
                    <div>
                        <p class="text-sm font-medium text-yellow-800">Este evento já passou da data de realização</p>
                        <p class="text-sm text-yellow-700 mt-1">Não é possível editar eventos passados. Você pode apenas visualizar ou gerar relatórios.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="flex items-center justify-end space-x-4">
                ...
                <button type="submit" id="submit-button" class="bg-[#1a5f3f] text-white px-8 py-3 rounded-lg font-semibold hover:bg-[#155030] transition flex items-center">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <script>
        ...
        window.addEventListener('DOMContentLoaded', function() {
            ...
            eventId = pathParts[pathParts.length - 2]; // /admin/events/{id}/edit
        ...
        function populateForm(event) {
            ...
            document.getElementById('price-input').value = event.price || 0;
            document.getElementById('image').value = event.image || '';
            document.getElementById('certificate_hours').value = event.certificate_hours || '';
            document.getElementById('certificate_description').value = event.certificate_description || '';

            // Assinaturas
            if (event.signature1_id) {
                document.getElementById('signature1_id').value = event.signature1_id;
            }
            if (event.signature2_id) {
                document.getElementById('signature2_id').value = event.signature2_id;
            }
            ...
            if (eventDate < today) {
                // Evento já passou - desabilitar edição
                document.getElementById('past-event-alert').classList.remove('hidden');
        ...
        async function handleSubmit(event) {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    alert('Erro ao atualizar evento: ' + (error.message || 'Tente novamente'));
                }
            } catch (error) {
